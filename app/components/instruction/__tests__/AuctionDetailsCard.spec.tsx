...
import { AuctionProgramErrorRow } from '@components/transaction/AuctionProgramErrorRow';
...
test('renders parsed auction v2 instruction details', () => {
...
test('renders auction parsed program errors only for auction failures', () => {
