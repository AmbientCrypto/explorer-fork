...
function BundleEscrowCard({ account, info }: { account: Account; info: BundleEscrowV2Info }) {
    ...
    return (
        <div className="card">
            <AccountHeader title="Auction Bundle Escrow V2" refresh={() => refresh(account.pubkey, 'parsed')} />
...
function BundleVerifierPageCard({ account, info }: { account: Account; info: BundleVerifierPageV2Info }) {
    ...
    return (
        <>
            <div className="card">
                <AccountHeader title="Auction Verifier Page V2" refresh={() => refresh(account.pubkey, 'parsed')} />
...
function ConfigPolicyCard({ account, info }: { account: Account; info: ConfigPolicyV2Info }) {
    ...
    return (
        <>
            <div className="card">
                <AccountHeader title="Auction Config Policy V2" refresh={() => refresh(account.pubkey, 'parsed')} />
    ...
    return (
        <tr>
            ...
            <td className="text-lg-end">
                ...
                {base58 && base64 ? <div className="text-muted small">Base64: {base64}</div> : null}
            </td>
        </tr>
    );
}
