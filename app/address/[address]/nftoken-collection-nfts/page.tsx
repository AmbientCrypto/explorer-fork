...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return {
        description: `NFToken NFTs belonging to the collection ${props.params.address} on Ambient`,
        title: `NFToken Collection NFTs | ${await getReadableTitleFromAddress(props)} | Ambient`,
    };
}
